"""
Think Pipeline - Etapa think do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/chief_systems_thinker.md"


def run_think(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline think.
...
{context}"
    return llm_adapter.complete(full_prompt, role="chief_systems_thinker")
