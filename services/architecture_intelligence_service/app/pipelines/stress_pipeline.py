"""
Stress Pipeline - Etapa stress do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/system_stress_tester.md"


def run_stress(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline stress.
...
{context}"
    return llm_adapter.complete(full_prompt, role="system_stress_tester")
