"""
Design Pipeline - Etapa design do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/chief_architect.md"


def run_design(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline design.
...
{context}"
    return llm_adapter.complete(full_prompt, role="chief_architect")
