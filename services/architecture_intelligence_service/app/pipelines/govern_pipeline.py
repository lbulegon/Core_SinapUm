"""
Govern Pipeline - Etapa govern do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/platform_governance_architect.md"


def run_govern(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline govern.
...
{context}"
    return llm_adapter.complete(full_prompt, role="platform_governance_architect")
