"""
Evolve Pipeline - Etapa evolve do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/system_evolution_architect.md"


def run_evolve(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline evolve.
...
{context}"
    return llm_adapter.complete(full_prompt, role="system_evolution_architect")
