"""
Review Pipeline - Etapa review do ciclo arquitetural.
...
PROMPT_FILE = "app/prompts/architecture_review_board.md"


def run_review(llm_adapter, input_content: str, previous_outputs: Optional[dict] = None) -> str:
    """
    Executa pipeline review.
...
{context}"
    return llm_adapter.complete(full_prompt, role="architecture_review_board")
