...
class ProviderBaileys(IWhatsAppProvider):
    ...
    def create_instance(self, instance_key: str) -> Dict[str, Any]:
        EventBus.emit(
            ...
            data={"error": "Provider baileys not implemented yet"},
        )
        raise NotImplementedError("Baileys provider not implemented")
    ...
    def health(self) -> Dict[str, Any]:
        return {"status": "error", "message": "Baileys provider not implemented yet"}
